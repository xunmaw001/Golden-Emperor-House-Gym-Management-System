...
public class JianshenqichaiChuruInoutEntity<T> implements Serializable {
    private static final long serialVersionUID = 1L;


	public JianshenqichaiChuruInoutEntity() {

	}

	public JianshenqichaiChuruInoutEntity(T t) {
		try {
    ...
    public String toString() {
        return "JianshenqichaiChuruInout{" +
            ", id=" + id +
