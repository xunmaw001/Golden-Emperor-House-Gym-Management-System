...
public class ForumEntity<T> implements Serializable {
     ...
     * 店长
     */
    @ColumnInfo(comment="店长",type="int(11)")
    @TableField(value = "dianzhang_id")
     ...
     * 驻场人员
     */
    @ColumnInfo(comment="驻场人员",type="int(11)")
    @TableField(value = "zhuchang_id")

    private Integer zhuchangId;
    ...
    public void setZhuchangId(Integer zhuchangId) {
        this.zhuchangId = zhuchangId;
    }
    /**
	 * 获取：用户
	 */
    ...
    public String toString() {
        return "Forum{" +
            ", id=" + id +
            ", forumName=" + forumName +
            ", dianzhangId=" + dianzhangId +
            ", qiantaiId=" + qiantaiId +
            ", zhuchangId=" + zhuchangId +
            ", yonghuId=" + yonghuId +
