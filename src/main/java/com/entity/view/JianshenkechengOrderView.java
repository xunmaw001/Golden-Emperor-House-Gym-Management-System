...
public class JianshenkechengOrderView extends JianshenkechengOrderEntity implements Serializable {
	...
	*/
	...
	private String jianshenkechengOrderValue;
	/**
	* 支付类型的值
	*/
	@ColumnInfo(comment="支付类型的字典表值",type="varchar(200)")
	private String jianshenkechengOrderPaymentValue;
	...
	//级联表 健身课程
		...
		* 课程价格
		*/
		@ColumnInfo(comment="课程价格",type="decimal(10,2)")
		private Double jianshenkechengNewMoney;
		/**
		* 健身课程介绍
		*/
	...
	public JianshenkechengOrderView() {

	}

	public JianshenkechengOrderView(JianshenkechengOrderEntity jianshenkechengOrderEntity) {
		try {
			BeanUtils.copyProperties(this, jianshenkechengOrderEntity);
	...
	* 获取： 订单类型的值
	*/
	public String getJianshenkechengOrderValue() {
		return jianshenkechengOrderValue;
	}
	/**
	* 设置： 订单类型的值
	*/
	public void setJianshenkechengOrderValue(String jianshenkechengOrderValue) {
		this.jianshenkechengOrderValue = jianshenkechengOrderValue;
	}
	//当前表的
	/**
	* 获取： 支付类型的值
	*/
	public String getJianshenkechengOrderPaymentValue() {
		return jianshenkechengOrderPaymentValue;
	}
	/**
	* 设置： 支付类型的值
	*/
	public void setJianshenkechengOrderPaymentValue(String jianshenkechengOrderPaymentValue) {
		this.jianshenkechengOrderPaymentValue = jianshenkechengOrderPaymentValue;
	}
	...
	//级联表的get和set 健身课程
		...
		* 获取： 课程价格
		*/
		public Double getJianshenkechengNewMoney() {
			return jianshenkechengNewMoney;
		}
		/**
		* 设置： 课程价格
		*/
		public void setJianshenkechengNewMoney(Double jianshenkechengNewMoney) {
			this.jianshenkechengNewMoney = jianshenkechengNewMoney;
		}
	...
	public String toString() {
		return "JianshenkechengOrderView{" +
			", jianshenkechengOrderValue=" + jianshenkechengOrderValue +
			", jianshenkechengOrderPaymentValue=" + jianshenkechengOrderPaymentValue +
			...
			", jianshenkechengNewMoney=" + jianshenkechengNewMoney +
