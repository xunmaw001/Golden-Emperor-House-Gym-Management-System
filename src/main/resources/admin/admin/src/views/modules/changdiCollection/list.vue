                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jianshenfangguanli/upload/changdiCollectionMuBan.xls"
                        >批量导入场地收藏数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('changdiCollection','导入导出')"
        ...
        methods: {
            chartDialog() {
                ...
                let params = {
                    ...
                    thisTable : {//当前表
                        tableName :'changdi_collection',//当前表表名,
                        sumColum : 'changdi_collection_number', //求和字段
                        date : 'insert_time',//分组日期字段
                        // string : 'changdi_collection_name',//分组字符串字段
                        // types : 'changdi_collection_types',//分组下拉框字段
                    },
                    // joinTable : {//级联表（可以不存在）
                ...
                //         groupColumn: "changdi_collection_types",
                //// riqi :getMonthFormat(_this.echartsDate),//年月
                //     }
                //     this.$http({
