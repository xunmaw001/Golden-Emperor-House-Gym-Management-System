        ...
        <el-form
            ...
            <el-row>
                <el-col :span="12"  v-if="sessionTable !='changdi'">
                    <el-form-item class="select" v-if="type!='info'"  label="场地信息" prop="changdiId">
                        <el-select v-model="ruleForm.changdiId" :disabled="ro.changdiId" filterable placeholder="请选择场地信息" @change="changdiChange">
                            <el-option
                ...
                <el-col :span="12" v-if="sessionTable !='changdi' ">
                    <el-form-item class="upload" v-if="type!='info' && !ro.changdiPhoto" label="场地照片" prop="changdiPhoto">
                        <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (changdiForm.changdiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.changdiPhoto" label="场地照片" prop="changdiPhoto">
                            <img style="margin-right:20px;" v-bind:key="index" v-for="(item,index) in (ruleForm.changdiPhoto || '').split(',')" :src="$base.url+item" width="100" height="100">
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='changdi' ">
                ...
                <el-col :span="12"  v-if="sessionTable !='changdi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="场地容量" prop="changdiKucunNumber">
                        <el-input v-model="changdiForm.changdiKucunNumber"
                                  placeholder="场地容量" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="场地容量" prop="changdiKucunNumber">
                            <el-input v-model="ruleForm.changdiKucunNumber"
                                      placeholder="场地容量" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12"  v-if="sessionTable !='changdi' ">
                    <el-form-item class="input" v-if="type!='info'"  label="场地热度" prop="changdiClicknum">
                        <el-input v-model="changdiForm.changdiClicknum"
                                  placeholder="场地热度" clearable readonly></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item class="input" label="场地热度" prop="changdiClicknum">
                            <el-input v-model="ruleForm.changdiClicknum"
                                      placeholder="场地热度" readonly></el-input>
                        </el-form-item>
                    </div>
                </el-col>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="预约编号" prop="changdiYuyueUuidNumber">
                       <el-input v-model="ruleForm.changdiYuyueUuidNumber"
                                 placeholder="预约编号" clearable  :readonly="ro.changdiYuyueUuidNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="预约编号" prop="changdiYuyueUuidNumber">
                           <el-input v-model="ruleForm.changdiYuyueUuidNumber"
            ...
            <input id="changdiId" name="changdiId" type="hidden">
                <el-col :span="24">
                    <el-form-item v-if="type!='info'"  label="备注" prop="sheshiyuyueText">
                        <el-input type="textarea"  :readonly="ro.sheshiyuyueText" v-model="ruleForm.sheshiyuyueText" placeholder="备注"></el-input>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.sheshiyuyueText" label="备注" prop="sheshiyuyueText">
                            <span v-html="ruleForm.sheshiyuyueText"></span>
                        </el-form-item>
                    </div>
                </el-col>
                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.changdiYuyueTime"  class="input" label="开始时间" prop="changdiYuyueTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.changdiYuyueTime"
                                type="datetime"
                                placeholder="开始时间"
                                :disabled="ro.changdiYuyueTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.changdiYuyueTime" label="开始时间" prop="changdiYuyueTime">
                            <span v-html="ruleForm.changdiYuyueTime"></span>
                        </el-form-item>
                    </div>
                </el-col>

                <el-col :span="12">
                    <el-form-item v-if="type!='info' && !ro.changdiJieshuTime"  class="input" label="结束时间" prop="changdiJieshuTime">
                        <el-date-picker
                                value-format="yyyy-MM-dd HH:mm:ss"
                                v-model="ruleForm.changdiJieshuTime"
                                type="datetime"
                                placeholder="结束时间"
                                :disabled="ro.changdiJieshuTime">
                        </el-date-picker>
                    </el-form-item>
                    <div v-else-if="type=='info'">
                        <el-form-item v-if="ruleForm.changdiJieshuTime" label="结束时间" prop="changdiJieshuTime">
                            <span v-html="ruleForm.changdiJieshuTime"></span>
                        </el-form-item>
                    </div>
                </el-col>
            ...
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.changdiYuyueYesnoTypes" label="预约状态" prop="changdiYuyueYesnoTypes">
                        <el-input v-model="ruleForm.changdiYuyueYesnoValue" placeholder="预约状态" readonly></el-input>
                    </el-form-item>
                </div>
            </el-col>
            <el-col :span="12" v-if="type=='info'">
                <div>
                    <el-form-item v-if="ruleForm.changdiYuyueYesnoText" label="审核回复" prop="changdiYuyueYesnoText">
                        <span v-html="ruleForm.changdiYuyueYesnoText"></span>
                    </el-form-item>
                </div>
            </el-col>
            </el-row>
    ...
    export default {
        data() {
            return {
                ...
                yonghuForm: {},
                ro:{
                    changdiYuyueUuidNumber: true,
                    yonghuId: false,
                    changdiId: false,
                    sheshiyuyueText: false,
                    changdiYuyueTime: false,
                    changdiJieshuTime: false,
                    changdiYuyueYesnoTypes: false,
                    changdiYuyueYesnoText: false,
                    insertTime: false,
                },
                ruleForm: {
                    changdiYuyueUuidNumber: new Date().getTime(),
                    yonghuId: '',
                    changdiId: '',
                    sheshiyuyueText: '',
                    changdiYuyueTime: '',
                    changdiJieshuTime: '',
                    changdiYuyueYesnoTypes: '',
                    changdiYuyueYesnoText: '',
                    insertTime: '',
                },
                changdiYuyueYesnoTypesOptions : [],
                changdiOptions : [],
                yonghuOptions : [],
                rules: {
        ...
        created() {
            ...
            //获取下拉框信息
                this.$http({
                    url:`dictionary/page?page=1&limit=100&sort=&order=&dicCode=changdi_yuyue_yesno_types`,
                    method: "get"
                }).then(({ data }) => {
                    if (data && data.code === 0) {
                        this.changdiYuyueYesnoTypesOptions = data.data.list;
                    }
                });
