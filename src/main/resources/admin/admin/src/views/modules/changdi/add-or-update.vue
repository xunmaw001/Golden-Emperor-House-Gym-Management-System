    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
                ...
                <el-col :span="12">
                    <el-form-item class="upload" v-if="type!='info' && !ro.changdiPhoto" label="场地照片" prop="changdiPhoto">
                        <file-upload
                            ...
                            :limit="3"
                            :multiple="true"
                            :fileUrls="ruleForm.changdiPhoto?$base.url+ruleForm.changdiPhoto:''"
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="场地容量" prop="changdiKucunNumber">
                       <el-input v-model="ruleForm.changdiKucunNumber"
                                 placeholder="场地容量" clearable  :readonly="ro.changdiKucunNumber"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="价格/分钟" prop="changdiNewMoney">
                       <el-input v-model="ruleForm.changdiNewMoney"
                                 placeholder="价格/分钟" clearable  :readonly="ro.changdiNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="价格/分钟" prop="changdiNewMoney">
                           <el-input v-model="ruleForm.changdiNewMoney"
                                     placeholder="价格/分钟" readonly></el-input>
                       </el-form-item>
                   </div>
               </el-col>
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.changdiContent"  label="场地介绍" prop="changdiContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   changdiKucunNumber: [
                              { required: true, message: '场地容量不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
                   ...
                   changdiNewMoney: [
                              { required: true, message: '价格/分钟不能为空', trigger: 'blur' },
                   ...
                   changdiClicknum: [
                              { required: true, message: '场地热度不能为空', trigger: 'blur' },
                              {  pattern: /^[0-9]*$/,
                                  message: '只允许输入整数',
                                  trigger: 'blur'
                              }
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.changdiContent = _this.ruleForm.changdiContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.changdiContent = this.ruleForm.changdiContent.replaceAll(this.$base.url,"");
                        this.$http({
