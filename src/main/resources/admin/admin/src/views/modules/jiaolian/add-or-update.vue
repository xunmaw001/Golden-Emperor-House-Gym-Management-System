    ...
    <div class="addEdit-block">
        <el-form
            ...
            <el-row>
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练名称" prop="jiaolianName">
                       <el-input v-model="ruleForm.jiaolianName"
                                 placeholder="教练名称" clearable  :readonly="ro.jiaolianName"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="教练邮箱" prop="jiaolianEmail">
                       <el-input v-model="ruleForm.jiaolianEmail"
                                 placeholder="教练邮箱" clearable  :readonly="ro.jiaolianEmail"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
               ...
               <el-col :span="12">
                   <el-form-item class="input" v-if="type!='info'"  label="工薪" prop="jiaolianNewMoney">
                       <el-input v-model="ruleForm.jiaolianNewMoney"
                                 placeholder="工薪" clearable  :readonly="ro.jiaolianNewMoney"></el-input>
                   </el-form-item>
                   <div v-else-if="type=='info'">
                       <el-form-item class="input" label="工薪" prop="jiaolianNewMoney">
                           <el-input v-model="ruleForm.jiaolianNewMoney"
                ...
                <el-col :span="24">
                    <el-form-item v-if="type!='info' && !ro.jiaolianContent"  label="教练简介" prop="jiaolianContent">
        ...
        data() {
            return {
                ...
                rules: {
                   ...
                   jiaolianEmail: [
                              { required: true, message: '教练邮箱不能为空', trigger: 'blur' },
        ...
        methods: {
            ...
            info(id) {
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        _this.ruleForm.jiaolianContent = _this.ruleForm.jiaolianContent.replaceAll("src=\"upload/","src=\""+this.$base.url+"upload/");
                    } else {
            ...
            onSubmit() {
                this.$refs["ruleForm"].validate(valid => {
                    if (valid) {
                        this.ruleForm.jiaolianContent = this.ruleForm.jiaolianContent.replaceAll(this.$base.url,"");
                        this.$http({
