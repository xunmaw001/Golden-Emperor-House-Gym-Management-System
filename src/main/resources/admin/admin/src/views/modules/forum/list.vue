            ...
            <el-table :data="forumData" height="250">
                ...
                <el-table-column label="身份">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.dianzhangId">
                            店长
                        </span>
                        <span v-if="scope.row.jiaolianId">
                            教练
                        </span>
                        <span v-if="scope.row.qiantaiId">
                            前台
                        </span>
                        <span v-if="scope.row.zhuchangId">
                            驻场人员
                        </span>
                ...
                <el-table-column label="姓名">
                        ...
                        <span v-if="scope.row.dianzhangId">
                            {{scope.row.dianzhangName}}
                        </span>
                        <span v-if="scope.row.jiaolianId">
                            {{scope.row.jiaolianName}}
                        </span>
                        <span v-if="scope.row.qiantaiId">
                            {{scope.row.qiantaiName}}
                        </span>
                        <span v-if="scope.row.zhuchangId">
                            {{scope.row.zhuchangName}}
                        </span>
                        <span v-if="scope.row.usersId">
                            管理员
                        </span>
                ...
                <el-table-column label="手机号">
                    <template slot-scope="scope">
                        ...
                        <span v-if="scope.row.dianzhangId">
                            {{scope.row.dianzhangPhone}}
                        </span>
                        <span v-if="scope.row.jiaolianId">
                            {{scope.row.jiaolianPhone}}
                        </span>
                        <span v-if="scope.row.qiantaiId">
                            {{scope.row.qiantaiPhone}}
                        </span>
                        <span v-if="scope.row.zhuchangId">
                            {{scope.row.zhuchangPhone}}
                        </span>
                        <span v-if="scope.row.usersId">
                            管理员
                        </span>
...
|| (sessionTable == 'dianzhang' && scope.row.dianzhangId ==userId)
|| (sessionTable == 'jiaolian' && scope.row.jiaolianId ==userId)
|| (sessionTable == 'qiantai' && scope.row.qiantaiId ==userId)
|| (sessionTable == 'zhuchang' && scope.row.zhuchangId ==userId)
        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '店长名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.dianzhangName" placeholder="店长名称" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '前台名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.qiantaiName" placeholder="前台名称" clearable></el-input>
                    </el-form-item>
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '驻场人员名称' : ''">
                        <el-input prefix-icon="el-icon-search" v-model="searchForm.zhuchangName" placeholder="驻场人员名称" clearable></el-input>
                    </el-form-item>
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/jianshenfangguanli/upload/forumMuBan.xls"
                        >批量导入交流论坛数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('forum','导入导出')"
                ...
                <el-table class="tables" :size="contents.tableSize" :show-header="contents.tableShowHeader"
                    ...
                    <el-table-column  :sortable="contents.tableSortable" :align="contents.tableAlign"
                        ...
                        <template slot-scope="scope">
                            ...
                            <span v-if="scope.row.dianzhangId">
                                <div v-if="scope.row.dianzhangPhoto">
                                    <img :src="$base.url+scope.row.dianzhangPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.jiaolianId">
                            ...
                            <span v-if="scope.row.qiantaiId">
                                <div v-if="scope.row.qiantaiPhoto">
                                    <img :src="$base.url+scope.row.qiantaiPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.zhuchangId">
                                <div v-if="scope.row.zhuchangPhoto">
                                    <img :src="$base.url+scope.row.zhuchangPhoto" width="100" height="100">
                                </div>
                                <div v-else>无图片</div>
                            </span>
                            <span v-if="scope.row.usersId">
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '现有余额': 'newMoney',
                     '驻场人员名称': 'zhuchangName',
                     '驻场人员手机号': 'zhuchangPhone',
                     '驻场人员头像': 'zhuchangPhoto',
                     '驻场人员邮箱': 'zhuchangEmail',
                     '工薪': 'zhuchangNewMoney',
                     '医院名': 'username',
                     '角色': 'role',
                     '新增时间': 'addtime',
        ...
        methods: {
            ...
            getDataList() {
                ...
                if (this.searchForm.dianzhangName!= '' && this.searchForm.dianzhangName!= undefined) {
                    params['dianzhangName'] = '%' + this.searchForm.dianzhangName + '%'
                }
                ...
                if (this.searchForm.qiantaiName!= '' && this.searchForm.qiantaiName!= undefined) {
                    params['qiantaiName'] = '%' + this.searchForm.qiantaiName + '%'
                }
                ...
                if (this.searchForm.zhuchangName!= '' && this.searchForm.zhuchangName!= undefined) {
                    params['zhuchangName'] = '%' + this.searchForm.zhuchangName + '%'
                }
                ...
                _this.$http({
                    ...
                    if (data && data.code === 0) {
                        ...
                        data.data.list.forEach(el=>{
                            ...
                            forum.dianzhangId = el.dianzhangId;//---
                            forum.dianzhangName = el.dianzhangName;
                            forum.dianzhangPhone = el.dianzhangPhone;
                            forum.dianzhangPhoto = el.dianzhangPhoto;
                            forum.dianzhangEmail = el.dianzhangEmail;
                            forum.dianzhangContent = el.dianzhangContent;
                            forum.dataDelete = el.dataDelete;
                            forum.insertTime = el.insertTime;
                            forum.createTime = el.createTime;
                            forum.qiantaiId = el.qiantaiId;//---
                            forum.qiantaiName = el.qiantaiName;
                            forum.qiantaiPhone = el.qiantaiPhone;
                            forum.qiantaiPhoto = el.qiantaiPhoto;
                            forum.qiantaiEmail = el.qiantaiEmail;
                            forum.qiantaiNewMoney = el.qiantaiNewMoney;
                            forum.qiantaiContent = el.qiantaiContent;
                            forum.dataDelete = el.dataDelete;
                            forum.insertTime = el.insertTime;
                            forum.createTime = el.createTime;
                            forum.zhuchangId = el.zhuchangId;//---
                            forum.zhuchangName = el.zhuchangName;
                            forum.zhuchangPhone = el.zhuchangPhone;
                            forum.zhuchangPhoto = el.zhuchangPhoto;
                            forum.zhuchangEmail = el.zhuchangEmail;
                            forum.zhuchangNewMoney = el.zhuchangNewMoney;
                            forum.zhuchangContent = el.zhuchangContent;
                            forum.dataDelete = el.dataDelete;
                            forum.insertTime = el.insertTime;
                            forum.createTime = el.createTime;
                            ...
                            forum.jiaolianNewMoney = el.jiaolianNewMoney;
