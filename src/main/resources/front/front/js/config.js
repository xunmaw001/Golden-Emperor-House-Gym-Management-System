...
var centerMenu = [
    ...
    ,{
        name: '场地留言',
        url: '../changdiLiuyan/list.html'
    }
    ,{
        name: '场地预约申请',
        url: '../changdiYuyue/list.html'
    }
    ,{
        name: '课程收藏',
        url: '../jianshenkechengCollection/list.html'
    }
    ,{
        name: '课程留言',
        url: '../jianshenkechengLiuyan/list.html'
    }
    ,{
        name: '课程订单',
        url: '../jianshenkechengOrder/list.html'
    }
...
// 已废弃,不用了
var adminurl =  "http://localhost:8080/jianshenfangguanli/admin/dist/index.html#/login";
